...
const ReviewSlide = () => {
  return (
    <div className='flex flex-nowrap w-full lg:w-[90%] snap-x overflow-x-auto'>

      {/* COMMENT 1 */}
      <article className='flex flex-col justify-evenly snap-center border border-black h-[300px] min-w-[300px] mx-2 p-2'>
